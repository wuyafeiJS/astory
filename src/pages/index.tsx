...
const IndexPage: NextPageWithLayout = () => {
  useEffect(() => {
    ...
    const stopPlay = document.getElementById('stop-audio')!;
    function translateCB(text: string) {
    ...
    const asrObj = new ASR({ translateCB, setUrl });
    ...
    stopButton.addEventListener('click', function () {
      asrObj.stopRecord();
      console.log(11, audioUrl);
    });
    playButton.addEventListener('click', function () {
      asrObj.playVoice(audioUrl);
    });
          ...
          <div className="container flex-1 items-start md:grid md:grid-cols-[220px_minmax(0,1fr)] md:gap-6 lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-10">
            ...
            <main className="">
              <div id="audio-controls">
                <Button id="start-recognition">开始识别</Button>|
                <Button id="stop-recognition">停止识别</Button>|
                <Button id="play-audio">播放音频</Button>|
                <Button id="stop-audio">停止播放音频</Button>|
              </div>
